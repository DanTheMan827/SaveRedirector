...
# It also starts Audica and optionally logs the output.
...
if ($help -eq $true) {
    Write-Output "`"Copy`" - Builds and copies your mod to your quest, and also starts Audica with optional logging"
    ...
    Write-Output "-Log `t`t Logs Audica using the `"Start-Logging`" command"
    Write-Output "-packageId `t Specifies the package name of the game (default: com.harmonixmusic.kata)"
